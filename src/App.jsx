// ============================================================
// Scott Wiener Dashboard — App.jsx
...
const DATA = {
  ...
  finances: {
    totalRaised: 1294152.2,
    emailDigital: 45386.0,
    smsDigital: 789.0,
    digitalTarget: 0.10,
    byMonth: [
      { month: "2025-11", total: 298525.0, digital: 3968.0 },
      { month: "2025-12", total: 270667.18, digital: 17662.0 },
      { month: "2026-01", total: 205677.17, digital: 7119.0 },
      { month: "2026-02", total: 275088.85, digital: 3703.0 },
      { month: "2026-03", total: 221530.0, digital: 12221.0 },
      { month: "2026-04", total: 22664.0, digital: 1502.0 }
    ],
  },

  texting: {
    campaigns: [
      { name: "250913_SW Masking Bill", date: "9/13/25", delivered: 4749, clicked: 282, revenue: 0 },
      { name: "SW EOQ #2", date: "9/30/25", delivered: 926, clicked: 150, revenue: 0 },
      { name: "251022_Launch Donors", date: "10/22/25", delivered: 4297, clicked: 612, revenue: 0 },
      { name: "251025 KICKOFF INVITE", date: "10/25/25", delivered: 16630, clicked: 2258, revenue: 0 },
      { name: "Kickoff - TURNOUT LAUNCH", date: "10/29/25", delivered: 18, clicked: 2, revenue: 0 },
      { name: "Congressional Forum Invite 251223", date: "12/23/25", delivered: 1592, clicked: 119, revenue: 0 },
      { name: "260110_SF ALL_Canvass Invite", date: "1/10/26", delivered: 11643, clicked: 239, revenue: 0 },
      { name: "260116_Canvass Tomorrow!", date: "1/16/26", delivered: 10973, clicked: 119, revenue: 0 }
    ],
    costPerMsg: 0.07,
  },

  googleAds: {
    period: "February 25, 2026 - March 24, 2026",
    campaigns: [
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", maxWidth:1100, margin:"0 auto", padding:20 }}>
      <h1 style={{ background:"#1F4E79", color:"#fff", padding:"12px 20px", borderRadius:6, marginBottom:16 }}>
        Scott Wiener — Digital Dashboard ({DATA.period})
      </h1>
